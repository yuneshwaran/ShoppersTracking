            ...
            <footer className="bg-dark text-white mt-5">
                <div className='container bg-dark mx-auto align-items-center text-center p-3'>
                    ...
                    <span className='d-flex justify-content-center'>
                        <a className='links' href='mailto:yuneshwaranr@unitedtechno.com' target='_blank'>Contact</a>
                        <a className='links mx-3' href='mailto:yuneshwaranr@unitedtechno.com' target="_blank">Feedback</a>
                        <a className='links' href='https://maps.app.goo.gl/Q3WHRdvLQ27XDZrz6' target="_blank">Location</a>
                    </span>
                </div>
            </footer>
        </Container>
